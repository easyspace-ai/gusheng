...
export async function listStrategies(params?: {
  ...
  return request<StrategySummary[]>(`/api/backtest/api/v1/strategies${query ? `?${query}` : ''}`)
}

export async function getStrategy(strategyId: number): Promise<StrategySummary> {
  return request<StrategySummary>(`/api/backtest/api/v1/strategies/${strategyId}`)
}

export async function createStrategy(payload: StrategyCreateRequest): Promise<StrategySummary> {
  return request<StrategySummary>('/api/backtest/api/v1/strategies', {
    method: 'POST',
    body: JSON.stringify(payload),
  })
}

export async function updateStrategy(strategyId: number, payload: StrategyUpdateRequest): Promise<StrategySummary> {
  return request<StrategySummary>(`/api/backtest/api/v1/strategies/${strategyId}`, {
    method: 'PUT',
    body: JSON.stringify(payload),
  })
...
export async function deleteStrategy(strategyId: number): Promise<void> {
  await request(`/api/backtest/api/v1/strategies/${strategyId}`, {
    method: 'DELETE',
  })
}

export async function validateStrategyCode(code: string): Promise<StrategyValidateResponse> {
  return request<StrategyValidateResponse>('/api/backtest/api/v1/strategies/validate', {
    method: 'POST',
...
export async function generateStrategy(payload: StrategyGenerateRequest): Promise<StrategyGenerateResponse> {
  return request<StrategyGenerateResponse>('/api/backtest/api/v1/strategies/generate', {
    method: 'POST',
    body: JSON.stringify(payload),
  })
}
...
export async function modifyStrategy(payload: StrategyModifyRequest): Promise<StrategyModifyResponse> {
  return request<StrategyModifyResponse>('/api/backtest/api/v1/strategies/modify', {
    method: 'POST',
    body: JSON.stringify(payload),
  })
}
...
export async function optimizeStrategy(
  ...
  return request<StrategyOptimizeResponse>(`/api/backtest/api/v1/strategies/${strategyId}/optimize`, {
    method: 'POST',
    body: JSON.stringify(payload),
  })
}
...
export async function explainStrategy(strategyId: number): Promise<StrategyExplainResponse> {
  return request<StrategyExplainResponse>(`/api/backtest/api/v1/strategies/${strategyId}/explain`, {
    method: 'POST',
  })
}
