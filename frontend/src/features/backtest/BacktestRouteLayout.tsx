  ...
  const leftPanel = (
    <div className="flex h-full flex-col bg-[#fbfcfd] dark:bg-slate-950">
      <div className="shrink-0 border-b border-slate-200 px-4 pb-3 pt-4 dark:border-slate-800">
        <h2 className="text-[15px] font-semibold text-slate-900 dark:text-slate-100">回测历史记录</h2>
          ...
          <div className="space-y-5 p-4">
            ...
            <section className="space-y-2">
              ...
              <Input
                ...
                onBlur={() => applySymbol(symbolInput, symbolSearchResults[0]?.name)}
                onKeyDown={(event) => {
                  if (event.key === 'Enter') {
            ...
            <section className="space-y-2">
              <label className="text-xs font-medium text-slate-500 dark:text-slate-400">策略选择</label>
              <div className="relative">
                <select
                  ...
                  className="h-11 w-full appearance-none rounded-xl border border-slate-200 bg-white px-3 pr-9 text-sm font-medium text-slate-900 shadow-sm outline-none transition focus:border-slate-300 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100"
                >
              ...
              {selectedStrategy ? (
                <div className="rounded-xl border border-slate-200 bg-slate-50/80 p-3 text-xs leading-5 text-slate-500 dark:border-slate-800 dark:bg-slate-900/50 dark:text-slate-400">
            ...
            <section className="grid grid-cols-2 gap-3">
              <label className="space-y-1.5">
                <span className="text-xs text-slate-500 dark:text-slate-400">开始日期</span>
                <Input
                  type="date"
                  value={runStartDate}
                  onChange={(event) => setRunStartDate(event.target.value)}
                  className="h-11 rounded-xl border-slate-200 bg-white text-sm shadow-sm dark:border-slate-800 dark:bg-slate-950"
                />
              </label>
              <label className="space-y-1.5">
                <span className="text-xs text-slate-500 dark:text-slate-400">结束日期</span>
                <Input
                  type="date"
                  value={runEndDate}
            ...
            <section className="space-y-2">
              <label className="text-xs font-medium text-slate-500 dark:text-slate-400">初始资金 (CNY)</label>
              <div className="relative">
                <Input
                  type="number"
                  value={initialCapital}
                  onChange={(event) => setInitialCapital(event.target.value)}
                  className="h-11 rounded-xl border-slate-200 bg-white pr-10 text-sm font-medium shadow-sm dark:border-slate-800 dark:bg-slate-950"
                />
                <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-sm text-slate-400">元</span>
              </div>
            </section>
            ...
            <section className="space-y-3">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">策略参数</div>
            ...
            <section className="space-y-3">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">交易成本与数据源</div>
        ...
        <ScrollArea className="min-h-0 flex-1">
          <div className="space-y-3 p-4">
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={refreshHistory} className="text-[11px] text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200">
                刷新
              </button>
            </div>
            {historyError ? (
